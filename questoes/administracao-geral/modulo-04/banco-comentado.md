...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 1, seção “Missão, visão e valores”.  
    **Erro mais provável:** escolher visão por achar a frase inspiradora.  
    **Dica VX:** pergunte “por que existimos hoje?”.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 1.  
    **Erro mais provável:** trocar missão e visão.  
    **Dica VX:** futuro desejado aponta para visão.
...
A. ameaça e força.  
B. fraqueza e oportunidade.  
C. força e oportunidade.  
D. oportunidade e força.  
E. força e fraqueza.
...
??? question "Mostrar resposta e comentário"
    ...
    **Termo da prova:** **SWOT**, quadro de forças, fraquezas, oportunidades e ameaças.  
    **Aula para revisar:** Aula 1.  
    **Erro mais provável:** classificar pelo efeito sem olhar a origem.  
    **Dica VX:** primeiro pergunte se o fator está dentro ou fora da organização.
...
B. Treinar a equipe; publicar um manual.  
C. Criar um grupo; contratar um sistema.  
D. Reduzir o tempo de atendimento; simplificar o formulário.  
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 1.  
    **Erro mais provável:** tratar qualquer verbo como objetivo.  
    **Dica VX:** objetivo responde “o que deve mudar?”.

## Bloco 2 — Níveis e instrumentos
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 2.  
    **Erro mais provável:** usar somente o prazo para classificar.  
    **Dica VX:** detalhe de tarefa aponta para operacional.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 2.  
    **Erro mais provável:** chamar de estratégico tudo que parece importante.  
    **Dica VX:** área ou unidade costuma indicar nível tático.
...
B. falta de alinhamento.  
C. existência de indicador.  
D. uso do nível operacional.  
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 2.  
    **Erro mais provável:** julgar a ação só pelo custo ou pelo tamanho.  
    **Dica VX:** procure a ligação entre cada ação e um objetivo.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 3.  
    **Erro mais provável:** escolher pelo prazo sem reconhecer a função.  
    **Dica VX:** “plurianual” lembra mais de um ano.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 3.  
    **Erro mais provável:** decorar siglas sem ligar cada uma à sua função.  
    **Dica VX:** LDO orienta; LOA prevê o dinheiro do ano.
...
B. a prioridade dispensa ligação com recursos.  
C. basta incluir uma atividade no nível operacional.  
D. a contradição é irrelevante porque os planos são independentes.  
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 3.  
    **Erro mais provável:** analisar cada documento de modo isolado.  
    **Dica VX:** confira direção, plano da área e possibilidade de executar.

## Bloco 3 — Gestão por resultados
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 4.  
    **Erro mais provável:** chamar qualquer item produzido de resultado.  
    **Dica VX:** antes da ação, procure os meios; são os insumos.
...
A. impacto e insumo.  
B. produto e resultado.  
C. resultado e atividade.  
D. meta e missão.  
E. visão e valor.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 4.  
    **Erro mais provável:** chamar entrega de resultado final.  
    **Dica VX:** pergunte “o que foi entregue?” e depois “o que mudou?”.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 4.  
    **Erro mais provável:** confundir bater uma meta com resolver o problema.  
    **Dica VX:** resultado público não é apenas produzir mais.

## Bloco 4 — Metas, indicadores e acompanhamento
...
B. Atendimento respeitoso.  
C. Acompanhar reclamações.  
D. Reduzir o prazo médio de 12 para 8 dias até dezembro.  
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 5.  
    **Erro mais provável:** aceitar uma intenção vaga como meta.  
    **Dica VX:** procure número e prazo.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 5.  
    **Erro mais provável:** confundir valor atual com meta.  
    **Dica VX:** linha de base é o “antes”; meta é o “onde queremos chegar”.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 5.  
    **Erro mais provável:** olhar somente se existe um número.  
    **Dica VX:** um indicador útil precisa chegar a tempo e manter o significado.
...
B. monitoramento.  
C. desenho do organograma.  
D. análise patrimonialista.  
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 5.  
    **Erro mais provável:** confundir acompanhar continuamente com avaliar em profundidade.  
    **Dica VX:** acompanhamento frequente aponta para monitoramento.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 5.  
    **Erro mais provável:** chamar todo uso de indicador de monitoramento.  
    **Dica VX:** perguntas de “por quê?” e “vale a pena?” apontam para avaliação.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aula 5.  
    **Erro mais provável:** concluir que “aconteceu depois” significa “aconteceu por causa”.  
    **Dica VX:** procure outras mudanças que possam explicar o efeito.
...
??? question "Mostrar resposta e comentário"
    ...
    **Aula para revisar:** Aulas 2, 4 e 5.  
    **Erro mais provável:** achar que bons indicadores substituem a execução.  
    **Dica VX:** confirme quem fará o quê e por que essa ação apoia o objetivo.
