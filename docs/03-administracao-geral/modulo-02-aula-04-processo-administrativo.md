---
id: administracao-geral-modulo-02-aula-04
title: "Processo administrativo: planejar, organizar, dirigir e controlar"
discipline: 03-administracao-geral
module: 2
lesson: 4
status: draft
edital_refs:
  - anexo-2-administracao-geral-processo-administrativo
  - anexo-2-administracao-geral-planejamento-organizacao-direcao-controle
prerequisites:
  - administracao-geral-modulo-02-aula-03
...
<section class="lesson-goal">
  ...
  <p>a transformar um objetivo em trabalho organizado e a acompanhar se o resultado está sendo alcançado.</p>
</section>
...
```mermaid
flowchart LR
    P[Planejar] --> O[Organizar]
    O --> D[Dirigir]
    D --> C[Controlar]
    C -->|informação para corrigir| P
```
