---
id: administracao-geral-modulo-04-aula-03
title: "Planejamento governamental e instrumentos públicos"
discipline: 03-administracao-geral
module: 4
lesson: 3
status: draft
edital_refs:
  - anexo-2-administracao-geral-planejamento-governamental
  - anexo-2-administracao-geral-instrumentos-planejamento-publico
prerequisites:
  - administracao-geral-modulo-04-aula-02
...
sources:
  ...
  - https://www.gov.br/tesouronacional/pt-br/estatisticas-fiscais-e-planejamento/planejamento-fiscal/sobre
...
<section class="lesson-goal">
  ...
  <p>como prioridades de governo se ligam a planos de médio prazo, orientações anuais e orçamento.</p>
</section>
...
```mermaid
flowchart LR
    PPA["PPA<br>direção, objetivos e metas<br>4 anos"] --> LDO["LDO<br>metas, prioridades e orientação<br>ano seguinte"]
    LDO --> LOA["LOA<br>estima receitas e fixa despesas<br>1 ano"]
    PPA --> LOA
```
