---
id: administracao-geral-modulo-02-aula-03
title: "Relações humanas, comportamento e visão sistêmica"
...
<section class="lesson-goal">
  ...
  <p>por que pessoas não são peças de uma máquina e por que uma organização precisa ser entendida como partes ligadas ao ambiente.</p>
</section>
...
```mermaid
flowchart LR
    A["Entradas<br>pessoas, dados e recursos"] --> B["Transformação<br>atividades e decisões"]
    B --> C["Saídas<br>serviços e resultados"]
    C --> D["Retorno de informação"]
    D --> B
    E["Ambiente"] --> A
    C --> E
```
