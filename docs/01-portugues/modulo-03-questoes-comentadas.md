---
title: Questões comentadas do Módulo 3
description: Questão oficial da FEPESE sobre hífen, adaptada e comentada.
status: draft
...
Assinale o grupo integralmente correto segundo o Acordo Ortográfico.

A) co-autor; extra-escolar; anti-social.  
B) papel-moeda; matéria-prima; bem-estar.  
C) auto-escola; contra-regra; infra-estrutura.  
D) anti-inflamatório; microondas; semi-deus.  
...
Esta ocorrência comprova que o hífen já foi cobrado pela FEPESE em uma questão que exigiu avaliar grupos de grafias. Um concurso e uma questão não demonstram frequência, preferência permanente nem previsão para a prova SAPE/SC.

## Fontes oficiais

- [Caderno S1 — InvestSC](https://2026cpinvestsc.fepese.org.br/?arquivo=S1.pdf&go=download&inline=1), página 4.
- [Gabarito definitivo retificado](https://2026cpinvestsc.fepese.org.br/?arquivo=2026_InvestSC_Gabarito_Definitivo_Retificado.pdf&go=download&inline=1).
- Consulta em 4 ago. 2026.

[← Flashcards](modulo-03-flashcards.md){ .md-button } [Questões autorais →](modulo-03-questoes-autorais.md){ .md-button .md-button--primary }
