...
*Secretaria* e *secretária* diferem por um acento que muda a tonicidade e o sentido. A decisão não começa com “tem acento?”; começa com pronúncia, separação e posição da tônica.

## Rota da acentuação

1. separe as sílabas;
2. localize a tônica;
3. classifique a palavra;
4. observe a terminação ou o caso específico;
5. aplique a regra.

> **Traduzindo:** acento gráfico marca certos casos definidos pela regra; ele não cria sozinho a sílaba tônica.

| Grupo | Regra operacional | Exemplos |
|---|---|---|
| proparoxítonas | todas são acentuadas | público, lâmpada |
| oxítonas | acentuam-se terminações previstas, como *a(s), e(s), o(s), em, ens* | café, também |
| paroxítonas | acentuam-se terminações previstas; a regra não é “todas” | fácil, caráter |
...
!!! warning "Erros comuns"
    Acentuar por memória visual; aplicar regra de oxítona a paroxítona; esquecer que o Acordo alterou grupos específicos; decorar exceção sem analisar a estrutura.

!!! info "FEPESE: limite da afirmação"
    O banco atual contém ocorrência oficial ligada à escrita, mas não amostra suficiente para afirmar preferência geral da FEPESE por uma regra de acentuação.

### Pausa para decidir

Por que *herói* tem acento e *heroico* não?

??? question "Resposta esperada"
    *Herói* é oxítona com ditongo aberto previsto na regra; *heroico* é paroxítona com ditongo aberto cujo acento foi retirado pelo Acordo.

**Dica de memorização:** nunca pule o **TERA**.

## Resumo

- classifique a palavra antes de aplicar regra;
- toda proparoxítona é acentuada;
- oxítonas, paroxítonas e monossílabos usam critérios próprios;
- o Acordo retirou acentos de grupos delimitados;
- acento diferencial permanece em casos específicos.
...
**Qual grupo é sempre acentuado?**

??? question "Mostrar resposta"
    Todas as proparoxítonas.

**Por que *ideia* não tem acento?**

??? question "Mostrar resposta"
    É paroxítona com ditongo aberto *ei*, grupo cujo acento foi retirado.

**Qual diferença existe entre *pode* e *pôde*?**

??? question "Mostrar resposta"
    *Pode* está no presente; *pôde*, no pretérito perfeito.

**Qual é o método TERA?**
...
- Acordo Ortográfico, Decreto nº 6.583/2008, Bases VIII a XII. Consulta em 4 ago. 2026.
- Academia Brasileira de Letras. VOLP digital 2025–2026. Consulta em 4 ago. 2026.

[← Aula 3](modulo-03-aula-03-ortografia-oficial.md){ .md-button } [Próxima: Aula 5 →](modulo-03-aula-05-hifen.md){ .md-button .md-button--primary }
