---
title: Questões comentadas do Módulo 4
description: Questões orientadas sobre classes, verbos, formação, flexão e pronomes.
status: draft
last_reviewed: 2026-08-04
---

# Questões comentadas do Módulo 4
...
A) substantivo. B) artigo. C) adjetivo ligado a equipe. D) advérbio que modifica respondeu. E) preposição.
...
A) passado concluído. B) futuro. C) hipótese passada. D) ordem. E) forma nominal.
...
A) *reler* é flexão. B) *livros* é derivação. C) *passatempo* é composição. D) *infeliz* é plural. E) *servidoras* é composição.
...
[← Flashcards](modulo-04-flashcards.md){ .md-button } [Questões autorais →](modulo-04-questoes-autorais.md){ .md-button .md-button--primary }
