---
title: Questões comentadas do Módulo 5
description: Questão oficial FEPESE adaptada sobre reescrita, regência e crase.
status: draft
last_reviewed: 2026-08-04
---

# Questões comentadas do Módulo 5
...
A frase “Todos concordaram com aquela proposta” mantém sentido e correção em:

A) Todos anuíram àquela proposta.  
B) Todos abdicaram àquela proposta.  
C) Todos retificaram àquela proposta.  
D) Todos impugnaram aquela proposta.  
...
A questão comprova uma cobrança integrada de equivalência lexical, regência e crase em um concurso. Não demonstra frequência nem permite prever que a SAPE/SC repetirá esse formato.
...
[← Flashcards](modulo-05-flashcards.md){ .md-button } [Questões autorais →](modulo-05-questoes-autorais.md){ .md-button .md-button--primary }
