...
Compare: “Embora o prazo fosse curto, a equipe concluiu a análise” e “Como o prazo era curto, a equipe concluiu a análise”. As duas frases estão gramaticalmente corretas, mas a primeira expressa concessão e a segunda, causa. Correção não garante equivalência.

## O que uma questão de reescrita exige

Reestruturar é mudar a forma sem perder o conteúdo que a alternativa promete preservar. A banca pode trocar voz verbal, ordem, conectivo, classe de palavra, oração por termo ou discurso direto por indireto. Cada troca exige conferências próprias.

> **Traduzindo:** equivalência significa manter as relações relevantes, não repetir as mesmas palavras.

| Mudança | O que conferir |
|---|---|
| ativa ↔ passiva | agente, paciente, tempo e concordância |
| oração ↔ termo nominal | relação lógica e regência |
| conectivo | causa, condição, concessão, conclusão etc. |
| ordem dos termos | alcance, ambiguidade e pontuação |
| pronome ou sinônimo | referente, sentido e preposição |
| discurso direto ↔ indireto | pessoa, tempo verbal e dêiticos |

## Método PRESERVA

1. **P**roposta: o enunciado pede correção, sentido ou ambos?
2. **R**elações lógicas: quais conectivos e dependências existem?
3. **E**ntidades: quem faz o quê a quem?
4. **S**entido das palavras: houve ampliação, restrição ou troca de valor?
5. **E**strutura: regência, concordância e colocação estão corretas?
6. **R**eferências: pronomes e elipses continuam claros?
...
!!! warning "Erros comuns"
    Aceitar sinônimo sem conferir regência; olhar apenas a correção; ignorar o alcance de *só*, *todos* e *alguns*; trocar concessão por causa; manter a pontuação da estrutura antiga.

!!! info "FEPESE: limite da afirmação"
    A amostra validada permite mostrar ocorrências concretas de reescrita, mas não sustenta generalização sobre frequência de cada transformação.

### Pausa para decidir

“Se houver recurso, o processo será revisto” equivale a “Embora haja recurso, o processo será revisto”?

??? question "Resposta esperada"
    Não. A primeira estabelece condição; a segunda, concessão. Ambas podem estar corretas, mas não têm a mesma relação lógica.

**Dica de memorização:** a alternativa deve **PRESERVA**r agentes, relações, referências e regras.

## Resumo

- correção e equivalência são critérios diferentes;
- uma troca formal pode alterar relação, alcance ou referente;
- conectivos devem ser comparados pelo valor contextual;
- a nova estrutura exige nova conferência gramatical;
- a última etapa é comparar as duas versões completas.
...
- [ ] Separo correção de equivalência.
- [ ] Confiro agentes, relações e referentes.
...
- Edital SAPE/SC nº 001/2026, Anexo 2, p. 27. Consulta em 4 ago. 2026.
- FEPESE_GUIDE.md. Critérios de evidência consultados em 4 ago. 2026.

[← Aula 6](modulo-06-aula-06-subordinadas-adjetivas-adverbiais.md){ .md-button } [Resumo →](modulo-06-resumo.md){ .md-button .md-button--primary }
