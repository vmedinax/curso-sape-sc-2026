...
description: Questões oficiais da FEPESE adaptadas com rastreabilidade e comentários.
status: draft
...
As questões abaixo foram **adaptadas**: o texto-base foi resumido e as alternativas foram reescritas para evitar reprodução extensa. Cargo, prova, número e gabarito permanecem identificados. Tente resolver antes de abrir.
...
- Errou 1 ou 2: revise agente, quantidade e comparação na [Aula 1](modulo-01-aula-01-compreensao-informacoes-explicitas.md).
- Errou 3: treine paráfrase sem acrescentar conhecimento de mundo.
- Acertou as três: explique a pista de cada resposta; acerto sem justificativa ainda não é domínio.

## Referências oficiais

- [Caderno S1 — InvestSC](https://2026cpinvestsc.fepese.org.br/?arquivo=S1.pdf&go=download&inline=1) e [gabarito definitivo retificado](https://2026cpinvestsc.fepese.org.br/?arquivo=2026_InvestSC_Gabarito_Definitivo_Retificado.pdf&go=download&inline=1). Consulta em 4 ago. 2026.
- [Caderno M1 — CISAMOSC](https://2025cisamosc.fepese.org.br/?arquivo=M1.pdf&go=download&inline=1) e [gabarito definitivo](https://2025cisamosc.fepese.org.br/?arquivo=2025_Cisamosc_Gabarito_Definitivo.pdf&go=download&inline=1). Consulta em 4 ago. 2026.

[← Flashcards](modulo-01-flashcards.md){ .md-button } [Questões autorais →](modulo-01-questoes-autorais.md){ .md-button .md-button--primary }
